# Generated by Django 2.1.4 on 2018-12-24 21:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('submitted_personnel', models.CharField(max_length=20, verbose_name='提交人员')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=120, verbose_name='用例/配置名称')),
                ...
                ('belong_module', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='background.ModuleInfo')),
            ],
            options={
                'verbose_name': '用例信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('belong_project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='background.ProjectInfo')),
            ],
            options={
                'verbose_name': '用例集合',
                'db_table': 'TestSuite',
        ...
        migrations.AddField(
            ...
            name='belong_project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='background.ProjectInfo'),
        ),
    ]
